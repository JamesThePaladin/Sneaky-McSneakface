...
public class AIState : MonoBehaviour
{
    ...
    public GameObject target; //var to hold enemy target
    public Transform tf; //to hold ai position
    ...
    public float health; //for healing
    ...
    {
        // TODO: Write code that changes our state and saves the time when we changed.
    }
